...
2. Edit `stack.env`: uncomment and set the variables you need (e.g. `AMAVISD_LOCAL_DOMAINS=example.com`, `MYDOMAIN=example.com`, `AMAVISD_SPAM_QUARANTINE_TO=...`, `AMAVISD_VIRUS_QUARANTINE_TO=...`).
